...
static void* demo_mount(struct fuse_conn_info * conn_info){
    ...
    /* 填充super信息 */
    super.sz_io =  sz_io/* TODO */;
    super.sz_disk =  sz_disk/* TODO */;
    super.sz_blks = 2 *  sz_io/* TODO */; 
